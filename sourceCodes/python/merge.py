...
#		filenames.append("/n/trombone/s1/wrbai/codes/output/postbcb-mean/plasm-%d-ch%d-lambda1-7-lambda2-15.txt"%(id,c))
        filenames.append(
            "/n/trombone/s1/wrbai/codes/output/postbcb/2016_6_29/Linfeng1/plasm-%d-ch%d-lambda1-7-lambda2-15.txt" % (id, c))
...
#	outputfile="/n/trombone/s1/wrbai/codes/msgfplus/linfeng_9_%d-1/linfeng.txt"%(id)
    ...
    outputfile = "/n/trombone/s1/wrbai/codes/output/postbcb/2016_6_29/Linfeng1/Linfeng-%d-lambda1-7-lambda2-15.txt" % (
        id)
