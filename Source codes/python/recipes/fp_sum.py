...
#
# Accurate floating point summations, like math.fsum, which is only available
# in Python 2.6 and above.
#
# TODO(ajit): Add in appropriate version of PSF License.

def fsum(iterable):
    return lsum(iterable)

def fnormalize(iterable):
    total = fsum(iterable)
    return [ float(v) / total for v in iterable ]

## Do not call code below these lines directly.
## {{{ http://code.activestate.com/recipes/393090/ (r5)
def msum(iterable):
...
## end of http://code.activestate.com/recipes/393090/ }}}
